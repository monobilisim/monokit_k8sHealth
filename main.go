// k8sHealth plugin for monokit2 — Kubernetes health: nodes, pods, ingress, cert-manager, kube-vip, etcd, EOL.
//
...
var pluginName string = "k8sHealth"
...
var configFiles []string = []string{"k8s.yml"}
